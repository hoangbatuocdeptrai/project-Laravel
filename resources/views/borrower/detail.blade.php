    ...
    <div class="email-content">
        <div class="row" style="display: flex;border: 1px solid #red;">
            ...
            <div class="col-md-6 top" style="float:right;">
                ...
                <p style="margin-top:-15px;margin-left:66px;font-weight:bold;"><i>Code: #{{$borrower->id}}</i></p>
        ...
        <div class="view-order-2">
            ...
            <table class="tb-2">
                ...
                <tr>
                    ...
                    <td class="b-none r-none td-m" style="text-align:center;"><b>{{$borrower->quantity}}</b></td>
                </tr>
            </table>
        </div>
    </div>
