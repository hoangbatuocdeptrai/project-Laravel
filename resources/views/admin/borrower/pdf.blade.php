    ...
    <div class="email-content">
        <div class="row" style="display: flex;border: 1px solid #red;">
            ...
            <div class="col-md-6 top" style="float:right;">
                ...
                <p style="margin-top:-15px;margin-left:66px;font-weight:bold;"><i>Code: #{{$borrower->token}}</i></p>
        ...
        <div class="view-order-2">
            <table class="tb-1 tab-left">
                ...
                <tr>
                    <td style="border-right: 1px solid #red;padding-left: 10px;">Name: {{$borrower->name}}</td>
                    <td style="padding-left: 10px;">Name: {{$borrower->cus->name}}</td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid #red;padding-left: 10px;">Email: {{$borrower->email}}</td>
                    <td style="padding-left: 10px;">Email: {{$borrower->cus->email}}</td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid #red;padding-left: 10px;">Phone: {{$borrower->phone}}</td>
                    <td style="padding-left: 10px;">Phone: {{$borrower->cus->phone}}</td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid #red;padding-left: 10px;">Address: {{$borrower->address}}</td>
                    <td style="padding-left: 10px;">Address: {{$borrower->cus->address}}</td>
                </tr>
            </table>
            <div>
            ...
            <table class="tb-2">
                ...
                <tr>
                    <td class="td-m" style="text-align:center;">{{$key}}</td>
                ...
                @endforeach
                <tr>
                    <td class="td-m" style="text-align:center;border-bottom: 2px solid #red"></td>
                    <td class="td-m" style="text-align:center;border-bottom: 2px solid #red"><b>Total</b></td>
                    <td style="text-align:center;border-bottom: 2px solid #red"><b>{{$borrower->quantity}}</b></td>
                </tr>
                <tr>
                    <td class="b-none td-m" style="text-align:center;"></td>
                    <td class="b-none td-m" style="text-align:center;"><b>Total Price</b></td>
                    <td class="b-none r-none td-m" style="text-align:center;"><b>${{$borrower->total_price}}</b></td>
                </tr>
            </table>
        </div>
    </div>
